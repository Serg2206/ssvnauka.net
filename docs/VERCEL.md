...
- `NEXT_PUBLIC_SITE_URL` - canonical URL for the deployed site, for example `https://ssvnauka.net`.
...
- Production: set `NEXT_PUBLIC_SITE_URL` to the public domain and point `INTAKE_POSTGRES_URL` at the live Supabase database.
